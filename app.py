...
# Dicionário Mestre 100% Completo (202 Itens Cozinha | 169 Itens Bar | 81 Itens Salão)
DADOS_SISTEMA = {
    "RESTAURANTE / COZINHA": {
        ...
        "DIVERSOS": ["PAPEL ALUMÍNIO", "PAPEL TOALHA INSTIT. C/ 06 UND", "BOBINA P ALIMENTOS", "MASCARA DESCARTAVEL DOBRAVEL", "SACO DE LIXO 200L", "FIBRACO SCOTCH BRITE", "FILME PVC 400MT", "ESCOVA DE ACO", "LAVA LOUCAS CONC. P. DILUIR 500ML", "DESENGORDURANTE ALCALINO CHEF", "ESPONJA DUPLA FACE", "AVENTAL BRANCO EM PVC", "CARVAO", "PAPEL MANTEIGA"]
    },
    "BAR": {
...
if item_nao_cadastrado:
    ...
    item_bruto = st.selectbox("Busque e selecione o Item:", sorted(list(set(lista_itens_plana))), key=f"item_select_{st.session_state.reset_counter}")
