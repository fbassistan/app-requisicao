...
# Banco de Dados Geral e Auditado (Cozinha, Bar e Salão)
DADOS_SISTEMA = {
    "RESTAURANTE / COZINHA": {
        ...
        "FRIOS / LATICINIOS": ["BACON KG", "CREAM CHEcheese 150G UND", "LEITE LEITÍSSIMO (L)", "MANTEIGA 500G", "MANTEIGA DE GARRAFA (L)", "PRESUNTO PARMA KG", "QUEIJO BRANCO M. FRESCAL KG", "QUEIJO COALHO KG", "QUEIJO GORGONZOLA KG", "QUEIJO GRANA PADANO 250G", "QUEIJO MUSSARELA KG", "QUEIJO PARMESÃO KG", "REQUEIJÃO CREMOSO UND"],
